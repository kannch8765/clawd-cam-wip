...
- source commit: `1f591816a4036b148a2dd79087ffd8af7b0f68f4`
...
[90mdocs/architecture.md[39m 136ms (unchanged)
[90mdocs/camera-device-smoke-test.md[39m 30ms (unchanged)
[90mdocs/capture-device-smoke-test.md[39m 28ms (unchanged)
[90mdocs/gallery-device-smoke-test.md[39m 34ms (unchanged)
[90mdocs/implementation-references.md[39m 119ms (unchanged)
[90mdocs/overlay-device-smoke-test.md[39m 22ms (unchanged)
[90mdocs/sharing-device-smoke-test.md[39m 13ms (unchanged)
...
[90mREADME.md[39m 13ms (unchanged)
[90msrc/app/App.test.tsx[39m 8ms (unchanged)
[90msrc/app/App.tsx[39m 18ms (unchanged)
[90msrc/features/camera/cameraAdapter.test.ts[39m 34ms (unchanged)
[90msrc/features/camera/cameraAdapter.ts[39m 33ms (unchanged)
[90msrc/features/camera/cameraTypes.ts[39m 20ms (unchanged)
[90msrc/features/camera/CameraView.test.tsx[39m 77ms (unchanged)
[90msrc/features/camera/CameraView.tsx[39m 48ms (unchanged)
...
[90msrc/features/composition/captureLifecycle.regression.test.tsx[39m 58ms (unchanged)
[90msrc/features/composition/CaptureResult.tsx[39m 9ms (unchanged)
[90msrc/features/composition/composePhoto.test.ts[39m 21ms (unchanged)
...
[90msrc/features/composition/usePhotoCapture.ts[39m 16ms (unchanged)
[90msrc/features/gallery/CaptureSave.integration.test.tsx[39m 43ms (unchanged)
[90msrc/features/gallery/galleryDatabase.test.ts[39m 51ms (unchanged)
[90msrc/features/gallery/galleryDatabase.ts[39m 16ms (unchanged)
[90msrc/features/gallery/GalleryDetail.tsx[39m 20ms (unchanged)
[90msrc/features/gallery/GalleryFlow.integration.test.tsx[39m 27ms (unchanged)
...
[90msrc/features/gallery/GalleryView.test.tsx[39m 57ms (unchanged)
...
[90msrc/features/overlay/CameraOverlay.test.tsx[39m 19ms (unchanged)
...
[90msrc/features/overlay/overlayGeometry.ts[39m 10ms (unchanged)
[90msrc/features/overlay/OverlayPreview.tsx[39m 4ms (unchanged)
[90msrc/features/overlay/overlayTypes.ts[39m 2ms (unchanged)
[90msrc/features/overlay/PinchDragCoordination.test.tsx[39m 18ms (unchanged)
[90msrc/features/overlay/referenceAsset.node.test.ts[39m 25ms (unchanged)
...
[90msrc/features/sharing/photoFile.ts[39m 15ms (unchanged)
...
[90msrc/styles/gallery.css[39m 47ms (unchanged)
[90msrc/styles/index.css[39m 23ms (unchanged)
[90msrc/styles/sharing.css[39m 4ms (unchanged)
[90msrc/test/setup.ts[39m 3ms (unchanged)
[90msrc/vite-env.d.ts[39m 1ms (unchanged)
[90mtask007-validation.md[39m 11ms (unchanged)
...
[1m[30m[46m RUN [49m[39m[22m [36mv4.1.10 [39m[90m/home/runner/work/clawd-cam-wip/clawd-cam-wip[39m
 ...
 [32m✓[39m src/features/gallery/galleryDatabase.test.ts [2m([22m[2m15 tests[22m[2m)[22m[32m 84[2mms[22m[39m
 [32m✓[39m src/features/composition/PhotoCapture.integration.test.tsx [2m([22m[2m10 tests[22m[2m)[22m[33m 1387[2mms[22m[39m
     [33m[2m✓[22m[39m shows the shutter only after camera and decoded asset are ready [33m 476[2mms[22m[39m
 [32m✓[39m src/features/gallery/GalleryView.test.tsx [2m([22m[2m13 tests[22m[2m)[22m[33m 1435[2mms[22m[39m
     [33m[2m✓[22m[39m shows loading and then the empty gallery action [33m 326[2mms[22m[39m
 [32m✓[39m src/features/camera/CameraView.test.tsx [2m([22m[2m13 tests[22m[2m)[22m[33m 1012[2mms[22m[39m
     [33m[2m✓[22m[39m requests the rear camera and enters ready after video readiness [33m 355[2mms[22m[39m
 [32m✓[39m src/features/composition/captureLifecycle.regression.test.tsx [2m([22m[2m4 tests[22m[2m)[22m[33m 777[2mms[22m[39m
     [33m[2m✓[22m[39m recovers after an asset decode failure and retry [33m 531[2mms[22m[39m
 [32m✓[39m src/features/sharing/SharingFlow.integration.test.tsx [2m([22m[2m2 tests[22m[2m)[22m[33m 954[2mms[22m[39m
     [33m[2m✓[22m[39m captures once, then shares, downloads, and independently saves the original Blob [33m 771[2mms[22m[39m
 [32m✓[39m src/features/sharing/usePhotoSharing.test.tsx [2m([22m[2m17 tests[22m[2m)[22m[33m 866[2mms[22m[39m
 [32m✓[39m src/features/composition/composePhoto.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 42[2mms[22m[39m
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.dev/link/wrap-tests-with-act
 ...
 [32m✓[39m src/features/gallery/CaptureSave.integration.test.tsx [2m([22m[2m7 tests[22m[2m)[22m[33m 788[2mms[22m[39m
     [33m[2m✓[22m[39m shows an explicit Save to gallery action without auto-saving [33m 327[2mms[22m[39m
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.dev/link/wrap-tests-with-act
 ...
 [32m✓[39m src/features/overlay/CameraOverlay.test.tsx [2m([22m[2m6 tests[22m[2m)[22m[33m 866[2mms[22m[39m
 [32m✓[39m src/features/composition/captureGeometry.test.ts [2m([22m[2m25 tests[22m[2m)[22m[32m 15[2mms[22m[39m
 [32m✓[39m src/features/gallery/GalleryFlow.integration.test.tsx [2m([22m[2m1 test[22m[2m)[22m[33m 787[2mms[22m[39m
     [33m[2m✓[22m[39m captures, saves, reloads, opens detail, and deletes one photo [33m 783[2mms[22m[39m
 [32m✓[39m src/features/overlay/referenceAsset.node.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 56[2mms[22m[39m
 [32m✓[39m src/features/sharing/photoFile.test.ts [2m([22m[2m15 tests[22m[2m)[22m[32m 20[2mms[22m[39m
 [32m✓[39m src/features/gallery/thumbnail.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 60[2mms[22m[39m
 [32m✓[39m src/features/camera/cameraAdapter.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 17[2mms[22m[39m
 [32m✓[39m src/features/overlay/PinchDragCoordination.test.tsx [2m([22m[2m1 test[22m[2m)[22m[33m 382[2mms[22m[39m
     [33m[2m✓[22m[39m suppresses the original drag until it fully ends after a two-pointer pinch [33m 378[2mms[22m[39m
 [32m✓[39m src/features/sharing/sharingAdapter.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 38[2mms[22m[39m
 [32m✓[39m src/features/overlay/overlayGeometry.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 13[2mms[22m[39m
 [32m✓[39m src/features/composition/captureAdapter.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 28[2mms[22m[39m
 [32m✓[39m src/features/overlay/useOverlayController.test.tsx [2m([22m[2m2 tests[22m[2m)[22m[33m 321[2mms[22m[39m
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.dev/link/wrap-tests-with-act
 ...
 [32m✓[39m src/app/App.test.tsx [2m([22m[2m1 test[22m[2m)[22m[32m 224[2mms[22m[39m
...
[2m   Duration [22m 13.03s[2m (transform 1.28s, setup 2.18s, import 3.91s, tests 10.18s, environment 17.31s)[22m
